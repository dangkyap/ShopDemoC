...
namespace ShopDemoC.Areas.Admin.Controllers
{
    public class PricesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ProductId,ApplyDate,Value,Type")] Price price)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ApplyDate,Value,Type")] Price price)
        {
            if (ModelState.IsValid)
            {
